<!-- Navigation -->
<header class="my-4 hidden w-48 shrink-0 flex-col justify-between gap-8 pl-4 sm:flex xl:ml-40">
    <div class="overflow-x-clip overflow-y-auto">
        <!-- Logo -->
        <a href="/"><svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182 61" fill="none">
