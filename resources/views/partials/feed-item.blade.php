<li class="flex items-start gap-4 not-first:pt-2.5">
    <a href="/profile" class="shrink-0">
        <img src="{{ $item->profile->avatar }}" alt="Avatar of {{ $item->profile->displayName }}"
        ...
        <div class="border-pixl-light/10 border-b pb-5">
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5 leading-0">
                    ...
                    <p>
                        <a href="/profile"
                            class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">{{ $item->profile->handle }}</a>
                    </p>
                </div>
        ...
        <ol>
            ...
            <li class="group/li relative flex items-start gap-4 pt-4">
                ...
                <a href="/profile" class="isolate shrink-0">
                    <img src="/images/alessia.png" alt="Avatar of Alessia" class="size-10 object-cover" />
                </a>
