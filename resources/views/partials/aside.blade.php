        ...
        <ol class="mt-4 flex flex-col gap-4">
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="images/alessia.png" alt="Avatar of Alessia" class="w-8 object-cover" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="images/anne.png" alt="Avatar of Anne" class="w-8 object-cover" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="images/mr-anderson.png" alt="Avatar of Mr. Anderson" class="w-8 object-cover" />
            ...
            <li class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5">
                    <img src="images/michael.png" alt="Avatar of Michael" class="w-8 object-cover" />
