...
<html lang="en">
  ...
  >
        ...
        <nav class="mt-10">
          <ul class="flex flex-col gap-3.5">
            ...
            <li class="-ml-4 flex items-center gap-2">
              ...
              <a class="hover:underline" href="/notifications">Notifications</a>
            </li>
            <li><a class="hover:underline" href="/lists">Lists</a></li>
            <li><a class="hover:underline" href="/bookmarks">Bookmarks</a></li>
            <li><a class="hover:underline" href="/jobs">Jobs</a></li>
            <li>
              <a class="hover:underline" href="/communities">Communities</a>
            </li>
            <li><a class="hover:underline" href="/premium">Premium</a></li>
            <li><a class="hover:underline" href="/profile">Profile</a></li>
            <li><a class="hover:underline" href="/more">More</a></li>
          </ul>
        </nav>
      </div>
      <!-- User controls -->
    ...
    <main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
      ...
      <div class="w-full">
        <nav
          class="overflow-x-auto [scrollbar-width:none] sm:overflow-x-visible"
        >
            ...
            <div class="border-pixl-light/10 border-b pb-5">
              ...
              <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-2.5 leading-0">
                  <p>
                    <a href="/profile" class="hover:underline">@mmich_jj</a>
                  </p>
              ...
              >
                ...
                <form action="" class="grow">
                  ...
                  <textarea
                    ...
                    id="reply"
                    rows="5"
                    placeholder="Reply to @mmich_jj's post"
              ...
              <li class="group/li relative flex items-start gap-4 pt-4">
                ...
                <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                  <div class="flex items-center justify-between gap-4">
                    <div class="flex items-center gap-2.5 leading-0">
                      <p>
                        <a href="/profile" class="hover:underline">Alessia</a>
                      </p>
