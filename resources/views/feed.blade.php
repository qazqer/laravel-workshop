<x-layout>
    ...
    <main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
        <!-- Navigation -->
        <div class="w-full">
            <nav class="overflow-x-auto [scrollbar-width:none] sm:overflow-x-visible">
        ...
        <div class="border-pixl-light/10 mt-8 flex items-start gap-4 border-b pb-4">
            ...
            <form action="" class="grow">
                ...
                <textarea name="post" id="post" placeholder="What's up _adrian?" class="w-full resize-none text-lg"></textarea>
                    ...
                    <div class="border-pixl-light/10 border-b pb-5">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            <div class="flex items-center gap-2.5 leading-0">
                                ...
                                <p>
                                    <a href="/profile"
                                        class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">@add-elle</a>
                                </p>
                            </div>
                        ...
                        <div class="border-pixl-light/10 bg-pixl-light/3 mt-8 flex items-start gap-4 border-t p-4">
                            ...
                            <form action="" class="grow">
                                ...
                                <textarea name="reply" id="reply" rows="5" placeholder="Reply to @mmich_jj's post"
                                    class="w-full resize-none text-sm"></textarea>
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex gap-4">
                                        <button type="button">
                            ...
                            <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex items-center gap-2.5 leading-0">
                                        ...
                                        <p>
                                            <a href="/profile"
                                                class="text-pixl-light/40 hover:text-pixl-light/60 text-xs">@alessia</a>
                                        </p>
                                    </div>
                                    <button class="group flex gap-[3px] py-2" aria-label="Post options">
                                        <span class="bg-pixl-light/40 group-hover:bg-pixl-light/60 size-1"></span>
