...
<template>
    ...
    >
        ...
        <main
            class="isolate mx-auto grid max-w-[1000px] grow place-items-center px-8 max-md:pt-16 md:h-full xl:max-w-6xl"
        >
            <div
            ...
            >
                ...
                <!-- Action Buttons -->
                <div class="max-w-full pb-16 min-[360]:w-72 sm:w-80">
                    <h1
